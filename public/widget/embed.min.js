window.addEventListener("load",function(){var e=document.createElement("style"),e=(e.appendChild(document.createTextNode(`
         @font-face {
      ...
      `)),document.head.appendChild(e),document.createElement("button"));let t=document.createElement("section");var n=document.createElement("div"),i=document.createElement("div"),o=document.createElement("div"),l=document.createElement("textarea"),d=document.createElement("button"),r=document.createElement("div"),a=document.createElement("p"),p=document.createElement("a"),s=document.createElement("button"),C=document.createElement("h6");C.textContent="Zaap",e.innerHTML=`<svg width="34" height="34" viewBox="0 0 226 247" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    `,e.style.cssText="outline: none; border-radius: 16px; border: none; background: #8748FF; height: 60px; width: 60px; transition: 0.3s all; position: fixed; right: 32px; bottom: 32px; cursor: pointer;",t.style.cssText="width: 300px; height: 434px; border-radius: 20px; position: absolute; bottom: 109px; right: 32px; display: none; flex-direction: column; background: #fff; border: 1px solid rgba(0, 0, 0, 0.05); box-shadow: 0px 0px 40px rgba(0, 0, 0, 0.1);",e.addEventListener("click",()=>{"none"===t.style.display?t.style.display="flex":t.style.display="none"}),n.style.cssText="width: 100%; padding: 12px 20px; display: flex; justify-content: space-between; place-items-: center; box-sizing: border-box; border-bottom: 1px solid rgba(0, 0, 0, 0.1);",C.style.cssText='font-family: "SuportalBold", sans-serif; font-size: 16px; margin: 0px;',s.innerHTML=`<svg width="11" height="11" viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    `,s.style.cssText="background: transparent; outline: none; border: none;",s.addEventListener("click",()=>{"none"===t.style.display&&(t.style.display="flex")}),o.style.cssText="padding: 0px 16px 4px 16px; max-height: 58px; position: relative;",r.style.cssText="width: 100%; display: flex; justify-content: center; gap: 6px 0px; place-items: center; border-top: 1px solid rgba(0, 0, 0, 0.1); padding: 5px; box-sizing: border-box;",p.innerHTML=`<svg width="52" height="15" viewBox="0 0 844 247" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    `,p.setAttribute("href","https://www.suportal.co"),p.setAttribute("target","_blank"),p.style.cssText="cursor: pointer;",a.textContent="Powered by",a.style.cssText='font-family: "SuportalBold", sans-serif; font-weight: bold; margin: 0px 8px 0px 0px; font-size: 11px;',r.appendChild(a),r.appendChild(p),i.style.cssText="height: 318px; overflow: scroll;",l.setAttribute("autofocus",""),l.rows=1,l.placeholder="How can I help?",l.style.cssText='resize: none; width: 100%; box-sizing: border-box; border: 2px solid #E8E8EB; border-radius: 25.5px; font-family: "SuportalMedium", sans-serif; font-weight: bold; padding: 10px 16px; outline-color: #007AFF !important;',d.innerHTML=`<svg width="12" height="10" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    `,d.style.cssText="background: #007AFF; border-radius: 50%; position: absolute; right: 22px; outline: none; border: none; height: 28px; width: 28px; bottom: 14px; cursor: pointer;",n.appendChild(C),n.appendChild(s),o.appendChild(l),o.appendChild(d),t.appendChild(n),t.appendChild(i),t.appendChild(o),t.appendChild(r),document.body.appendChild(e),document.body.appendChild(t)});