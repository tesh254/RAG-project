function getURL(){return new URL(window.location.href).hostname}function getChatBot(t){var e=getURL();fetch("https://app.suportal.co/api/chat/"+e).then(e=>e.json()).then(e=>{t.textContent=e.chatbot.title}).catch(e=>{t.textContent="Chat"})}function sendMessage(e,r,t,n,s){var i=document.createElement("div"),i=(i.classList.add("chat-message"),i.style.cssText='background-color: #007AFF; color: #fff; font-family: "SuportalMedium", sans-serif; font-weight: medium; align-self: flex-end; margin: 4px 0px 8px 0px;',i.textContent=t,r.appendChild(i),getURL());n.disabled=!0;const d=document.createElement("div");d.classList.add("chat-message"),d.style.cssText='background: #E8E8EB; color: #000; font-family: "SuportalMedium", sans-serif; font-weight: medium; align-self: flex-start; margin: 4px 0px 8px 0px;',d.textContent="Typing...",r.appendChild(d),fetch("https://app.suportal.co/api/chat",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({message:t,website_link:i})}).then(e=>{const o=e.body.getReader(),a=new TextDecoder,l=({done:e,value:t})=>{if(!e){e=a.decode(t,{stream:!0});if("Typing..."===d.textContent)d.textContent=e;else{var n=e.split("\n");for(let e=0;e<n.length;e++){var i=n[e];""!==i&&(i=document.createTextNode(i),d.appendChild(i),e<n.length-1)&&(i=document.createElement("br"),d.appendChild(i))}}return r.scrollTop=r.scrollHeight,s.scrollTop=s.scrollHeight,o.read().then(l)}};return o.read().then(l)}).catch(()=>{n.disabled=!1,d.textContent="Sorry, there was an error while processing your request. Please try again later or contact support if the problem persists."}),n.disabled=!1,clearInput(e)}async function clearInput(e){e.value="",e.focus()}window.addEventListener("load",function(){var e=document.createElement("style"),e=(e.appendChild(document.createTextNode(`
      ...
      `)),document.head.appendChild(e),document.createElement("button"));let t=document.createElement("section");var n=document.createElement("div"),i=document.createElement("div");let o=document.createElement("div");var a=document.createElement("div");let l=document.createElement("textarea"),r=document.createElement("button");var s=document.createElement("div"),d=document.createElement("p"),p=document.createElement("div"),c=document.createElement("a"),C=document.createElement("button"),x=document.createElement("h6");x.textContent="Zaap",getChatBot(x),e.innerHTML=`<svg width="34" height="34" viewBox="0 0 226 247" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    `,C.style.cssText="background: transparent; outline: none; border: none;",C.addEventListener("click",()=>{"flex"===t.style.display&&(t.style.display="none")}),a.style.cssText="padding: 0px 16px 4px 16px; max-height: 58px; position: relative;",s.style.cssText="width: 100%; display: flex; justify-content: center; gap: 6px 0px; place-items: center; border-top: 1px solid rgba(0, 0, 0, 0.1); padding: 5px; box-sizing: border-box;",c.innerHTML=`<svg width="52" height="15" viewBox="0 0 844 247" fill="none" xmlns="http://www.w3.org/2000/svg">
