function getURL(){var e=new URL(window.location.href),t=e.port?":"+e.port:"";return e.protocol+"//"+e.hostname+t}function getChatBot(t){var e=getURL();fetch("https://app.suportal.co/api/chat/"+btoa(e),{method:"GET"}).then(e=>e.json()).then(e=>{t.textContent=e.chatbot.title}).catch(e=>{t.textContent="Chat"})}function sendMessage(e,d,t,n,s){var o=document.createElement("div"),o=(o.classList.add("chat-message"),o.style.cssText='background-color: #007AFF; color: #fff; font-family: "SuportalMedium", sans-serif; font-weight: medium; align-self: flex-end; margin: 4px 0px 8px 0px;',o.textContent=t,d.appendChild(o),getURL());n.disabled=!0;const p=document.createElement("div");p.classList.add("chat-message"),p.style.cssText='background: #E8E8EB; color: #000; font-family: "SuportalMedium", sans-serif; font-weight: medium; align-self: flex-start; margin: 4px 0px 8px 0px;',p.textContent="Typing...",d.appendChild(p),fetch("https://app.suportal.co/api/chat",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({message:t,website_link:o})}).then(e=>{const a=e.body.getReader(),l=new TextDecoder,r=({done:e,value:t})=>{if(!e){e=l.decode(t,{stream:!0});if("Typing..."===p.textContent)p.textContent=e;else{var n=e.split("\n");for(let e=0;e<n.length;e++){var o,i=n[e];""!==i&&(i=document.createTextNode(i),p.appendChild(i),e<n.length-1)&&(i=document.createElement("br"),o=document.createElement("br"),p.appendChild(i),p.appendChild(o))}}return d.scrollTop=d.scrollHeight,s.scrollTop=s.scrollHeight,a.read().then(r)}};return a.read().then(r)}).catch(()=>{n.disabled=!1,p.textContent="Sorry, there was an error while processing your request. Please try again later or contact support if the problem persists."}),n.disabled=!1,clearInput(e)}async function clearInput(e){e.value="",e.focus()}window.addEventListener("load",function(){var e=document.createElement("style"),e=(e.appendChild(document.createTextNode(`
         @font-face {
    ...
    `,r.style.cssText="background: #007AFF; border-radius: 50%; display: flex; justify-content: center; place-items: center; outline: none; border: none; height: 28px; width: 28px; cursor: pointer;",p.style.cssText="width: 100%; height: 100%; overflow: hidden; border: 2px solid #E8E8EB; border-radius: 25.5px; border-box: box-sizing; display: grid; grid-template-columns: 1fr auto; grid-template-rows: 42px; gap: 0px 4px; place-items: center; padding: 5px 7px;",p.appendChild(l),p.appendChild(r),n.appendChild(x),n.appendChild(C),a.appendChild(p),r.addEventListener("click",()=>{sendMessage(l,i,l.value,r,t)}),o.appendChild(i),t.appendChild(n),t.appendChild(o),t.appendChild(a),t.appendChild(d),document.body.appendChild(e),document.body.appendChild(t)});