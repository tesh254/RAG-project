...
const BotForm = () => {
  ...
  const script = `<script src="https://app.suportal.co/widget/embed.js"></script>`;
  ...
  return (
    <div className="w-full h-screen">
      <div className="mx-auto my-auto w-[450px]">
        ...
        <div className="grid grid-col-2">
          ...
          <div className="relative h-[120px]">
            <Input
              ...
              label="Website link"
              onChange={onChange}
              inputClassname="bg-transparent mb-[10px]"
          ...
          <div className="relative">
            <div className="base-input__container">
              ...
              <div className="base-input flex space-x-[24px] place-items-center">
                <p
                  className="text-suportal-gray-dark text-opacity-90"
                >
                  {script}
                </p>
                <Button
